 ...
 */
public class ShareCollectionDO {
    ...
    public ShareCollectionDO() {
    }

    public ShareCollectionDO(Integer id, Integer userId, Integer shareId, Date createTime, Date updateTime) {
        this.id = id;
        this.userId = userId;
