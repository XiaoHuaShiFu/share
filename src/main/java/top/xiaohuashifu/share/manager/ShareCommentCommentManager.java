...
public interface ShareCommentCommentManager {
    ...
    Result<ShareCommentCommentVO> getShareCommentComment(Integer id);

    Result<PageInfo<ShareCommentCommentVO>> listShareCommentComments(ShareCommentCommentQuery query);
